...
const Communication = () => {
  ...
  return (
    <div className="space-background text-white w-screen min-h-screen flex flex-col">
      ...
      <div className="max-w-screen mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
      {!joined ? (
        <div className="w-full mb-6 floating-element">
      ...
      <div className="mt-6 w-full space-container p-4 rounded-lg floating-element">
